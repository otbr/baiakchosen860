...
CTF_LIB = {
	waitpos = {x = 1374, y = 930, z =7}, -- Posição da sala de espera
	tppos = {x = 167, y = 51, z =7}, -- Onde o TP vai aparecer
	...
	teams = {
		["Vermelho"] = {
			...
			flag = {
				id = 1435,
				flag_pos = {x = 1404, y = 1000, z =6}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 1401, y = 1000, z =6}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},
		...
		["Verde"] = {
			...
			flag = {
				id = 1437,
				flag_pos = {x = 1352, y = 1000, z =6}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 1355, y = 1000, z =6}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
